...
export default function CreateTrabalhador() {
  ...
  function formatCamelCaseToText(value: string): string {
    if (!value) return "";
  ...
  // Suporte a nomes aninhados como 'documentosPessoais.cpf'
          ...
          {[
            ...
            <button
              ...
              ${activeTab === tab.key
                  ...
                  : "border-transparent cursor-pointer hover:text-blue-600"
                }`}
            >
              {tab.label}
            </button>          
        ...
        <div className={`${activeTab === "documentos" ? "block pointer-events-auto" : "hidden pointer-events-none"}`} >
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            ...
            <div>
              ...
              <input
                ...
                className="border p-2 w-full"
                name="documentosPessoais.nisPisPasep"
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div>
              ...
              <input
                ...
                className="border p-2 w-full"
                name="documentosPessoais.numeroCtps"
            ...
            <div>
              ...
              <input
                ...
                className="border p-2 w-full"
                name="documentosPessoais.numeroSerieCtps"
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div>
              ...
              <select
                name="documentosPessoais.ufCtps"
            ...
            <div>
              ...
              <input
                ...
                placeholder="RG"
                className="border p-2 w-full"
                name="documentosPessoais.numeroRg"
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div>
              ...
              <select
                name="documentosPessoais.emissaoRg"
            ...
            <div>
              ...
              <input
                type="date"
                name="documentosPessoais.dataExpedicaoRg"
                className="border p-2 w-full"
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div>
              ...
              <input
                type="text"
                name="documentosPessoais.numeroRegistroOc"
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div>
              ...
              <input
                type="date"
                name="documentosPessoais.dataExpedOc"
                className="border p-2 w-full"
            ...
            <div>
              ...
              <input
                type="date"
                name="documentosPessoais.dataValidadeOc"
                className="border p-2 w-full"
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div>
              ...
              <input
                type="text"
                name="documentosPessoais.numeroCnh"
            ...
            <div>
              ...
              <input
                type="date"
                name="documentosPessoais.dataExpedicaoCnh"
                className="border p-2 w-full"
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            ...
            <div>
              ...
              <input
                type="date"
                name="documentosPessoais.dataValidadeCnh"
                className="border p-2 w-full"
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            ...
            <div>
              ...
              <input
                type="text"
                name="documentosPessoais.categoriaCnh"
          ...
          <div className={activeTab === "endereco" ? "block" : "hidden"}>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div>
                ...
                <select
                  name="enderecoResidencial.tipoLogradouro"
              ...
              <div>
                ...
                <input
                  type="text"
                  name="enderecoResidencial.logradouro"
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div>
                ...
                <input
                  type="text"
                  name="enderecoResidencial?.numero"
                  placeholder="Númeroo"
                  className="border p-2 w-full"
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div>
                ...
                <input
                  type="text"
                  name="enderecoResidencial.municipio"
